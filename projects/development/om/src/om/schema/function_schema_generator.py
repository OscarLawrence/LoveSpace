    ...
    def generate_function_schema(
        ...
        for arg in func_node.args.args:
            ...
            if arg.annotation:
                try:
                    ...
                    type_schema = self.analyzer._analyze_string_annotation(
                        annotation_str
                    )
        ...
        if func_node.returns:
            try:
                ...
                return_type_schema = self.analyzer._analyze_string_annotation(
                    return_annotation
                )
        ...
        result = {"parameters": schema, "returns": return_schema}
