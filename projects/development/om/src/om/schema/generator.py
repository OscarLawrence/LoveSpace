...
class SchemaGenerator:
    ...
    def generate_function_schema(
        self, func_node: ast.FunctionDef, module_globals: dict = None
    ) -> dict[str, Any]:
        """Generate JSON schema for function parameters and return type."""
        return self.function_generator.generate_function_schema(
            func_node, module_globals
        )
        ...
        for py_file in source_dir.rglob("*.py"):
            ...
            try:
                ...
                if module_schemas:
                    ...
                    self.doc_generator.generate_json_schema_file(
                        module_schemas, output_file
                    )
    ...
    def generate_documentation(
        self, schemas: dict[str, Any], title: str = "Type Documentation"
    ) -> str:
