...
class ModuleIsolation:
    ...
    def filter_relevant_context(self, module_name: str, task_type: str) -> dict:
        ...
        module_functions = [
            f for f in functions if self._is_file_relevant(f.file_path, relevant_files)
        ]
        module_classes = [
            c for c in classes if self._is_file_relevant(c.file_path, relevant_files)
        ]
    ...
    def enforce_module_boundaries(
        self, module_name: str, proposed_changes: dict
    ) -> bool:
    ...
    def _is_change_allowed(
        self, module_name: str, file_path: str, boundaries: dict
    ) -> bool:
