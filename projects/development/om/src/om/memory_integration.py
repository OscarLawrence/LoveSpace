...
from .module_isolation import ModuleIsolation
...
class MemoryIntegration:
    ...
    def inject_context_to_command(
        self, command: str, args: dict, module: str = None
    ) -> dict:
    ...
    def suggest_context_aware_commands(
        self, current_state: dict, module: str = None
    ) -> list[str]:
    ...
    def auto_save_session_state(self, project_id: str, state: dict, module: str = None):
        ...
        if module:
            context = self.module_isolation.filter_relevant_context(
                module, "session_save"
            )
    ...
    def personalize_output(
        self, output: str, preferences: dict, module: str = None
    ) -> str:
    ...
    def manage_module_handoffs(
        self, from_module: str, to_module: str, context: dict = None
    ) -> dict:
    ...
    def cleanup_old_data(self, days: int = 30):
        ...
        self.module_isolation.db.conn.execute(
            "DELETE FROM sessions WHERE last_accessed < ?", [cutoff_date]
        )
