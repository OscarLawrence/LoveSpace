...
class TradingSystemRunner:
    ...
    def __init__(self):
        self.bot: MicroTradingBot | None = None
        self.background_process: subprocess.Popen | None = None
    ...
    def start_background(self, duration_hours: int = 24):
        ...
        try:
            ...
            print(
                f"✅ Trading bot started in background (PID: {self.background_process.pid})"
            )
            print("📁 Logs will be written to: trading_bot.log")
            return True
...
def main():
    ...
    start_parser = subparsers.add_parser(
        "start", help="Start trading bot in background"
    )
