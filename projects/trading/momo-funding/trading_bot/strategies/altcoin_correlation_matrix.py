...
class AltcoinCorrelationDetector:
    ...
    def find_best_opportunities(
        self, market_data: dict[str, list[dict]], max_opportunities: int = 5
        ...
        opportunities = []
        available_assets = [
            asset for asset in self.altcoin_universe.keys() if asset in market_data
        ]
        ...
        for asset1, asset2 in pairs_to_check:
            ...
            if (
                breakdown_magnitude > 0.35
            ):  # Slightly lower than BTC/ETH (0.4) due to higher volatility
                confidence = min(
                    breakdown_magnitude * 1.5, 0.9
                ...
                if asset1 in self.altcoin_universe and asset2 in self.altcoin_universe:
                    vol_adjustment = (
                        self.altcoin_universe[asset1].volatility
                        + self.altcoin_universe[asset2].volatility
                    ) / 2
