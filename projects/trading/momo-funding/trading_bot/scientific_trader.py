...
class ScientificTrader:
    ...
    def __init__(self, min_confidence: float = 0.75, max_position: float = 0.02):
        ...
        self.correlation_detector = create_correlation_detector(
        ...
        print("🧬 Scientific Trader initialized")
    ...
    def convert_to_strategy_data(
        self, market_data: list[MarketData]
    ) -> list[StrategyMarketData]:
    ...
    def scan_for_opportunities(self) -> TradingSignal | None:
        """
        ...
        signal = self.correlation_detector.detect_breakdown(
            btc_strategy_data, eth_strategy_data
        )
