...
class FeedbackLoop:
    ...
    async def process_feedback(
        ...
        active_strategies: dict[str, "OptimizationStrategy"],
    ) -> None:
    ...
    async def _analyze_performance_changes(
        self,
        metrics_history: deque,
        active_strategies: dict[str, "OptimizationStrategy"],
    ) -> None:
    ...
    async def _correlate_with_strategies(
        self,
        ...
        most_used_strategy = max(
            active_strategies.values(), key=lambda s: s.usage_count
        )
    ...
    async def _detect_learning_patterns(self) -> None:
        ...
        for feedback in recent_feedback:
            ...
            context_performance[context_type][feedback.strategy_name].append(
    ...
    async def _apply_learned_optimizations(
        ...
        for rule in self.adaptation_rules:
            ...
            if rule["type"] == "increase_priority":
                ...
                strategy.effectiveness_score = min(
                ...
                strategy.effectiveness_score = max(
                    strategy.effectiveness_score - adjustment, 0.0
                )
    ...
    def add_user_feedback(
        self, strategy_name: str, rating: float, context: dict[str, Any]
    ) -> None:
    ...
    def get_strategy_learning_summary(self, strategy_name: str) -> dict[str, Any]:
        ...
        return {
            ...
            "consistency": 1 - np.std(recent_improvements)
