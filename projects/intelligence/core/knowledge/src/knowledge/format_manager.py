...
class FormatManager:
    ...
    def _load_global_format(self) -> FormatType | None:
    ...
    def compress_documentation(
        ...
        content: str,
        url: str | None = None,
        format_type: FormatType = FormatType.DENSE,
    ) -> str:
    ...
    def _format_verbose(self, title: str, content: str, url: str | None) -> str:
    ...
    def _format_natural(self, title: str, content: str, url: str | None) -> str:
    ...
    def _format_dense(self, title: str, content: str, url: str | None) -> str:
    ...
    def _format_auto(self, title: str, content: str, url: str | None) -> str:
...
def compress_doc(
    ...
    fmt = (
        FormatType(format_type.lower())
        if format_type != "auto"
        else format_manager.select_format(context)
    )
