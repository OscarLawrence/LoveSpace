...
class DenseDescriptionGenerator:
    ...
    def generate_dense_function_description(
    ...
    def _generate_hierarchical_description(self, func: Function) -> str:
        ...
        if patterns:
            ...
            primary_patterns = [
                p for p in patterns if p in ["async", "error_handling", "validation"]
            ]
    ...
    def _extract_action(self, func_name: str) -> str | None:
    ...
    def _infer_domain(self, func: Function) -> str | None:
    ...
    def _extract_io_description(self, func: Function) -> str | None:
