...
class CodeAnalyzer:
    def __init__(self):
        self.complexity_thresholds = {"function": 10, "class": 20, "file": 200}
                ...
                if file.endswith(".py"):
                    ...
                    for metric in complexity_metrics:
                        if (
                            ...
                            > self.complexity_thresholds["function"]
                        ):
                            violations.append(
                                f"{file_path}:{metric.function_name} (complexity: {metric.complexity_score})"
                            )
